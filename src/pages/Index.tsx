...
const Index = () => (
  <>
    <SEO
      ...
      description="Cabeceros, pufs, mesas y pantallas tapizados a medida y hechos a mano en España. Más de 60 telas disponibles. Elige tela, tamaño y acabado — en 30 días en tu casa."

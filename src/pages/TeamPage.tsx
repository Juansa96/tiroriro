...
const FACTS = [
  ...
  { label: "Plazo de entrega", value: "30 días naturales desde la confirmación" },
...
const TeamPage = () => (
  <>
    <SEO
      title="Quiénes somos | Tiroriro · Dos familias que hacen encuentros"
      description="Tiroriro lo fundamos dos parejas en Boadilla del Monte. Hacemos a mano cabeceros, bancos, pufs, mesas y pantallas: los sitios donde una familia se para, se mira y habla."
      canonical="https://tirorirohome.com/nosotros"
    />
    <Navbar />
    <main className="pt-20 md:pt-24">
      {/* Introducción breve (src/data/narrativa.ts); debajo, "Los cuatro" y los datos clave. */}
      <section className="py-16 md:py-24 px-6">
        <div className="container mx-auto max-w-3xl">
          <AnimatedSection className="text-center">
            <p className="text-[10px] tracking-[0.22em] uppercase text-muted-foreground mb-4">{QUIENES_SOMOS.kicker}</p>

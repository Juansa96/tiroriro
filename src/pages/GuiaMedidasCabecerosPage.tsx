...
const FAQS = [
  ...
  { q: "¿Qué anchos de cabecero fabricáis?", a: "Nuestras medidas de serie son 90, 105, 135, 150, 160, 180 y 200 cm. Además puedes pedir cualquier medida entre 60 y 300 cm desde la opción “Otra medida” del configurador. Hasta 200 cm de ancho no hay suplemento de fabricación; a partir de 200 cm aplicamos un pequeño extra porque lleva más madera, más tela y más horas de trabajo. (El envío se calcula aparte: el configurador te lo detalla.)" },

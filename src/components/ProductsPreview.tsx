                    ...
                    <Link to={product.link} className="block group h-full">
                      <div className="relative overflow-hidden rounded-xl">
                        <img
                          ...
                          alt={product.alt}
                          className={`w-full aspect-[3/5] object-cover transition-transform duration-700 ease-out ${product.id === 'bancos' ? 'origin-bottom scale-[1.15] group-hover:scale-[1.18]' : 'group-hover:scale-[1.03]'}`}

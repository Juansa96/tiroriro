...
const REASONS = [
  ...
  { num: "03", title: "Tú solo abres la puerta", text: "Sin buscar tapiceros, sin pedir presupuestos, sin coordinar entregas. Nuestro equipo gestiona todo para que el resultado llegue listo a tu casa en 20 días." },
];

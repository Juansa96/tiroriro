...
const FAQS = [
  ...
  },
  {
    ...
    a: "Todo se fabrica a mano en nuestro taller de la Comunidad de Madrid, en España. Trabajamos con tapiceros artesanos con décadas de oficio. Por eso podemos personalizar cada pieza al milímetro y por eso el plazo es de 30 días: nada está prefabricado.",
  },
  {
    q: "¿Cuánto tarda en llegar mi pedido?",
    a: "El plazo habitual es de 30 días naturales (un mes) desde que confirmamos y recibimos el pago. En épocas de alta demanda puede alargarse 2-3 días — siempre te avisamos antes.",
  },
  {

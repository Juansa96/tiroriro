...
const STEPS = [
  ...
  },
  {
    ...
    text: "En unos 30 días lo recibes listo para colocar, ya sea apoyado, colgado o tal y como lo hayas elegido. Y si estás en Madrid, también podemos instalarlo por ti.",
    Icon: House,

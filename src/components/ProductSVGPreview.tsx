...
const headboardPath = (forma: string): string => {
  switch (forma) {
    ...
    case 'corona-simple':
      return "M 15 185 Q 15 185 15 178 L 15 152 C 15 140 28 133 50 138 C 68 142 82 118 150 72 C 218 118 232 142 250 138 C 272 133 285 140 285 152 L 285 178 Q 285 185 285 185 L 15 185 Z";
    case 'corona-doble':
      return "M 15 185 L 15 158 C 18 138 35 128 58 136 C 74 141 84 150 96 142 C 106 135 122 108 150 90 C 178 108 194 135 204 142 C 216 150 226 141 242 136 C 265 128 282 138 285 158 L 285 185 Z";
    case 'recto':
    default:

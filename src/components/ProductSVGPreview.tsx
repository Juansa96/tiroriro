...
const headboardPath = (forma: string): string => {
  switch (forma) {
    ...
    case 'corona-simple':
      return "M 15 185 L 15 150 C 15 140 28 135 55 138 C 78 140 95 118 150 78 C 205 118 222 140 245 138 C 272 135 285 140 285 150 L 285 185 Z";
    case 'corona-doble':
      return "M 15 185 L 15 148 L 15 148 C 15 132 25 126 42 130 Q 58 134 65 118 L 65 95 Q 65 55 150 28 Q 235 55 235 95 L 235 118 Q 242 134 258 130 C 275 126 285 132 285 148 L 285 185 Z";
    case 'recto':
    default:
